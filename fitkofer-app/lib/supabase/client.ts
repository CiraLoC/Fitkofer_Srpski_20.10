...
const extraConfig =
  ...
  (Constants.manifest as { extra?: Record<string, unknown> } | null | undefined)?.extra ??
  manifest2Extra;

const supabaseUrl =
  (extraConfig?.supabaseUrl as string | undefined) ?? process.env.EXPO_PUBLIC_SUPABASE_URL;
