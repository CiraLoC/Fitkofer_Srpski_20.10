    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        {dayLabels.map((label, index) => {
          ...
          return (
            <TouchableOpacity
              ...
              style={[
                styles.dayPill,
                selected ? styles.dayPillSelected : undefined,
              ]}
            ...
            <View style={styles.mealHeader}>
              <View>
                ...
                <Text style={styles.mealMeta}>
                  {meal.calories} kcal • P {meal.protein}g • U {meal.carbs}g • M{" "}
                  {meal.fats}g
                </Text>
              </View>
              <TouchableOpacity
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.copy}>
          Izaberi zamenu ako ti treba varijacija, kalorije ostaju u istoj zoni.
        </Text>
