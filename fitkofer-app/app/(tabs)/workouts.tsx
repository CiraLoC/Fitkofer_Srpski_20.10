    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.hero}>
        ...
        <Text style={styles.copy}>
          ...
          zaredom odradiš gornji broj ponavljanja u svim serijama, podigni
          težinu za 2.5-5%.
        </Text>
      </View>
              ...
              <View key={entry.day} style={styles.scheduleRow}>
                ...
                <View style={styles.sessionInfo}>
                  <Text style={styles.sessionTitle}>
                    {session ? session.title : "Oporavak / šetnja"}
                  </Text>
                  <Text style={styles.sessionMeta}>
                    {session
                      ? `${session.durationMinutes} min`
                      : "Mobilnost, NSDR, 6k koraka"}
                  </Text>
                </View>
              </View>
            );
          ...
          <View key={session.id} style={styles.card}>
            ...
            >
              <View>
                ...
                <Text style={styles.sessionMeta}>
                  {session.exercises.length} vežbi · {session.durationMinutes}{" "}
                  min ·{" "}
                  {session.difficulty === "beginner" ? "Početni" : "Srednji"}{" "}
                  nivo
                </Text>
              </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.tipList}>
          <Text style={styles.tip}>
            • Vodi evidenciju ponavljanja i težina u Planner ekranu.
          </Text>
          <Text style={styles.tip}>
            • Pauze 60-90 sekundi za višezglobne, 45-60 za izolacione vežbe.
          </Text>
          <Text style={styles.tip}>
            • Prvo tehnika, zatim tempo: spuštanje 2s, kontrolisan povratak.
          </Text>
        </View>
      </View>
    </ScrollView>
